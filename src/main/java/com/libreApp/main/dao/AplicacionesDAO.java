...
public interface AplicacionesDAO {
	List<AplicacionesDTO> obtenerAplicacionPorNombreCategoriaLicenciaValoracion(Integer id_app, String nombre_app, String version, String fecha, String link_imagen, String link_descarga, String descripcion, Integer id_categoria);
