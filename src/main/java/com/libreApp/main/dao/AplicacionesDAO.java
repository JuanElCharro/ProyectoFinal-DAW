...
public interface AplicacionesDAO {
	List<AplicacionesDTO> obtenerAplicacionPorNombreCategoriaLicenciaValoracion(String nombre_app, String version, String fecha, String link_imagen, String link_descarga, String descripcion);
