		...
		<div class="row">
			<div class="col-xl-4">
				...
				<ul class="nav nav-pills flex-column">
					...
					<li class="nav-item"><a id="licenciasPrivativas"
						class="nav-link"
					...
					<li class="nav-item"><br></li>
					<li class="nav-item"><a id="licenciasPrivativas"
						class="nav-link" href="https://www.defectivebydesign.org/">Software
							con DRM</a></li>
					<li class="nav-item"><br></li>
					<li class="nav-item"><a id="licenciasLibres" class="nav-link"
					...
					<li class="nav-item"><br></li>
					<li class="nav-item"><a id="licenciasLibres" class="nav-link"
						href="https://www.mozilla.org/en-US/MPL/">Mozilla Public
							License</a></li>
				</ul>
				<hr>
				...
				<div class="d-none d-xl-block">
					...
					<p>Es importante el uso y desarrollo de programas libres en
						...
						mejoras globales sobre los programas, sino tambien porque facilita
				...
				<div id="app">
					<h2>Calidad</h2>
					<h5>Valore la infomacion mostrada en la web e indique lo que
						le gustaria cambiar o mejorar:</h5>
					<p>La infomacion mostrada es correcta:</p>
					<label class="contenedor">Si lo es <input type="radio"
						name="opt" v-model="respuestaInfo" value="Info Correcta">
						<span class="checkmark"></span>
					</label> <label class="contenedor">No lo es <input type="radio"
						name="opt" v-model="respuestaInfo" value="Info Incorrecta">
						<span class="checkmark"></span>
					</label> <label class="contenedor">Ns/Nc <input type="radio"
						name="opt" v-model="respuestaInfo" value="No sabe/No contesta">
						<span class="checkmark"></span>
					</label>
					<p>La infomacion le ha resultado util:</p>
					<label class="contenedor">Es de utilidad <input
						type="radio" name="opt2" v-model="respuestaUtilidad"
						value="Utilidad Correcta"> <span class="checkmark"></span>
					</label> <label class="contenedor">No es de utilidad <input
						type="radio" name="opt2" v-model="respuestaUtilidad"
						value="Utilidad Incorrecta"> <span class="checkmark"></span>
					</label> <label class="contenedor">Ns/Nc <input type="radio"
						name="opt2" v-model="respuestaUtilidad"
						value="No sabe/No contesta"> <span class="checkmark"></span>
					</label>
					<p>Problemas encontrados (opcional):</p>
					<textarea v-model="desarrollo" name="txarea" id="txarea" rows="5"
						maxlength="1000" placeholder="Desarrolle el/los problemas..."></textarea>
			...
			<div class="col-xl-8 col-lg-9 col-sm-12">
				...
				<video class="d-none d-md-block d-lg-block d-xl-block"
					...
					<source src="media/inicio/Fight-to-Repair-720p.webm"
						type="video/webm">
					</source>
				</video>
				<p>
				...
				<img class="d-none d-md-block d-lg-block d-xl-block"
					id="separacion-imagentexto-inicio"
					src="media/inicio/opensourceinitiative.png"
				...
				<img class="d-none d-md-block d-lg-block d-xl-block"
					id="separacion-imagentexto-inicio"
					src="media/inicio/Eliminate_DRM.png" alt="opensourceiniciative"
				...
				<p>Los grandes medios trataran de hacerte creer que DRM
					...
					proposito es restringirte a ti, el usuario, es más apropiado
					describir DRM como Gestion Digital de Restricciones. Las
					tecnologias DRM pueden restringir el acceso del público a
