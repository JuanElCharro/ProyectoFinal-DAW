					...
					<div class="container" style="margin-top:30px">
						<div class="col-12">
							<div class="form-group">
								<form action="http://localhost:8080/libreApp/formularioEliminarPrograma" method="post"
									id="formulario">
								...
								<form action="http://localhost:8080/libreApp/eliminarPrograma" method="post"
									id="formulario">
									<div class="row">

										<c:forEach items="${lista}" var="programa">
											<div class="col-12 col-md-6 col-lg-4">
												<div class="card bg-light border-danger" style="margin-bottom: 1em;">
													...
													<div class="card-body">
														<h5 class="card-title"><strong>${programa.nombre_app}</strong>
														</h5>
														<!-- Recoger ID para borrarlo -->
														<label for="nombre_app"></label>
														<input type="text" id="nombre_app" name="nombre_app" value="${programa.nombre_app}"
															readonly>
													...
													<a hidden href="${programa.link_descarga}"
														class="btn btn-success">Descarga</a>
